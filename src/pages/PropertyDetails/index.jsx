    ...
    return (
        <div className="container">
            ...
            <span className="property__feature">
              <i className="property__feature-icon fa-solid fa-bed"></i> {property.beds} Beds
            </span>
                        <span className="property__feature">
              <i className="property__feature-icon fa-solid fa-bath"></i> {property.baths} Baths
            </span>
                        <span className="property__feature">
              <i className="property__feature-icon fa-solid fa-ruler-combined"></i> {property.area} m²
            </span>
                    </div>
                    <p className={`property__status property__status--${property.status.toLowerCase()}`}>
                        {property.status}
                    </p>
                </div>
            </div>
                    ...
                    <div className="carousel-inner">
                        {property.images.map((image, index) => (
                            <div className={`carousel-item ${index === 0 ? "active" : ""}`} key={image.id}>
                                <img src={image.image_url} className="carousel__image d-block w-100" alt={`Property Image ${image.id}`} />
                            </div>
                        ))}
                    </div>
