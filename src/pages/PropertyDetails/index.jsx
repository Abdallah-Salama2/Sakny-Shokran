        ...
        <div className={"container-fluid"}>
            <div className="row position-relative">
                <div className="col-12 form-button position-sticky">
                    <button
                        type="button"
                        className="btn btn-primary form-button-text"
                        onClick={handleShow}
                    >
                        Contact Form
                    </button>
                ...
                <div className="col-9 property-info ">
                    <div className="px-3">
                        ...
                        <div
                            className=" property-info d-flex justify-content-start align-items-center gap-2  text-muted flex-wrap fs-5">
                            <br />
                            <br />
            ...
            <div className="row mx-1">
                <div className="col-6 property-agent d-flex align-items-center ">
                    <h1 className={"d-block  my-0"}>The Agent</h1>
                </div>
            </div>
            <div className="row my-2 mx-1">
                <div className=" col-6 property-agent d-flex align-items-center">
                    <hr className="border border-dark border-3 opacity-75 w-25 d-block my-0"></hr>
                </div>
            </div>
            <div className="row ">

                <div className="  col-6  property-agent d-flex">
